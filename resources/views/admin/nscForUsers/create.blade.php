...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.nscForUser.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.nsc-for-users.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_maturity') ? 'is-invalid' : '' }}" type="text" name="date_maturity" id="date_maturity" value="{{ old('date_maturity') }}">
