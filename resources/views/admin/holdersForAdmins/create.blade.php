...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.holdersForAdmin.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.holders-for-admins.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhar_no') ? 'is-invalid' : '' }}" type="text" name="aadhar_no" id="aadhar_no" value="{{ old('aadhar_no', '') }}" required>
