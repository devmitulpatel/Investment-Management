...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.insuranceForUser.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.insurance-for-users.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('insured_amount') ? 'is-invalid' : '' }}" type="number" name="insured_amount" id="insured_amount" value="{{ old('insured_amount', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('insurance_type') ? 'is-invalid' : '' }}" name="insurance_type" id="insurance_type">
                    ...
                    @foreach(App\Models\InsuranceForUser::INSURANCE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('insurance_type', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('insured_period') ? 'is-invalid' : '' }}" type="number" name="insured_period" id="insured_period" value="{{ old('insured_period', '') }}" step="1">
